...
from uopweixin.util.configurl import memeraddressurl,signUpOpenActUrl,personalCenterUrl
from uopweixin.util.jsonTransform import transUopHttpHears
from uopweixin.center.personal.parsePersonalCenterJson import parseUserPointByRspJSON
