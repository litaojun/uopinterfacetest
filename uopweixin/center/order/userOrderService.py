...
from uopweixin.util.configurl import memeraddressurl,signUpOpenActUrl,personalCenterUrl,userOrderUrl
from uopweixin.util.jsonTransform import transUopHttpHears
from uopweixin.center.order.paserMemberOrderJson import parseUseOrderListByRspJSON
